...
import type { SalesOrderDetail } from '@/modules/vendor/types';
...
export function VendorOrderDetail({ order }: VendorOrderDetailProps) {
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-3">
                        <h1 className="text-2xl font-bold tracking-tight">Pedido {order.customerOrderNumber}</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-sm text-muted-foreground">{order.billToCity} - {order.billToState}</p>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardHeader className="pb-2">
